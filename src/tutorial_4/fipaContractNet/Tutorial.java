...
public class Tutorial {
	...
	public static void main(String[] args) {
		...
		parameters[0] = "-gui";
		parameters[1] = "printer1:tutorial_4.fipaContractNet.PrinterAgent;printer2:tutorial_4.fipaContractNet.PrinterAgent;worker:tutorial_4.fipaContractNet.WorkerAgent;";
